...
public class UserSerializationTest
{
    ...
    public void shouldReadV1SerializationFormat() throws Exception
    {
        ...
        // When
        List<User> deserialized = serialization.deserializeRecords( UTF8.encode( new StringBuilder().append("Mike:SHA-256,FE0056C37E,A543:\n").append("Steve:SHA-256,FE0056C37E,A543:nice_guy,password_change_required\n").append("Bob:SHA-256,0E1FFFC23E,34A4:password_change_required\n").toString() ) );
