...
public class FormattedLog extends AbstractLog
{
            ...
            Supplier<ZonedDateTime> dateTimeSupplier )
    {
        ...
        String debugPrefix = ( category != null && !category.isEmpty() ) ? new StringBuilder().append("DEBUG [").append(category).append("]").toString() : "DEBUG";
        String infoPrefix = ( category != null && !category.isEmpty() ) ? new StringBuilder().append("INFO [").append(category).append("]").toString() : "INFO ";
        String warnPrefix = ( category != null && !category.isEmpty() ) ? new StringBuilder().append("WARN [").append(category).append("]").toString() : "WARN ";
        String errorPrefix = ( category != null && !category.isEmpty() ) ? new StringBuilder().append("ERROR [").append(category).append("]").toString() : "ERROR";
