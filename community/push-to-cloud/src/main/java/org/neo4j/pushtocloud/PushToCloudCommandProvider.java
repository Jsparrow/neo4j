...
public class PushToCloudCommandProvider extends AdminCommand.Provider
{
    ...
    {
        return new StringBuilder().append("Push your local database to a Neo4j cloud instance. The database must be shutdown in order to take a dump to upload. ").append("The target location is your Neo4j Cloud Bolt URI. You will be asked your Neo4j Cloud username and password during ").append("the push-to-cloud operation.").toString();
    }
